export const KYCvalidataions = {
    ...
    CurrentAddress: {
        "city": "Please Enter  City in Local/Permanent Address",
        "country": "Please Enter  Country in Local/Permanent Address",
        "district": "Please Enter  District in Local/Permanent Address",
        "houseName": "Please Enter  Address1 in Local/Permanent Address",
        "addressType": "Please Select  client Address Type",
        "pinCode": "Please Enter  PinCode in Local/Permanent Address",
        "proofOfAddress": "Please Select  Proof Of Address in Local/Permanent Address",
        "state": "Please Enter  State in Local/Permanent Address",
        "street": "Please Enter  Address2 in Local/Permanent Address",
        "landmark": "Please Enter  Address3 in Local/Permanent Address"
    },
    ...
    LocalAddress: {
        "city": "Please Enter  City in Correspondence/Foreign Address",
        "country": "Please Enter  Country in Correspondence/Foreign Address",
        "district": "Please Enter  District in Correspondence/Foreign Address",
        "houseName": "Please Enter  Adress 1 in Correspondence/Foreign Address",
        "pinCode": "Please Enter  PinCode in Correspondence/Foreign Address",
        "proofOfAddress": "Please Select  Proof Of Address in Correspondence/Foreign Address",
        "state": "Please Enter  State in Correspondence/Foreign Address",
        "street": "Please Enter  Adress 2 in Correspondence/Foreign Address",
        "landmark": "Please Enter  Adress 3 in Correspondence/Foreign Address"
    },
